...
-(void)initBackground
{
    ...
    switch (backgroundLevel) {
        case 1:
            if(frontOpen) {
                //--------------------Front Background--------------------//
                bgFront1 = [CCSprite spriteWithFile:@"background1_front.png"];     
                bgFront2 = [CCSprite spriteWithFile:@"background1_front.png"];
//                bgFront1 = [CCSprite spriteWithFile:@"level3_bg.png"];
//                bgFront2 = [CCSprite spriteWithFile:@"level3_bg.png"];
            }
            if(middleOpen) {
                //--------------------Middle Background--------------------//
                bgMiddle1 = [CCSprite spriteWithFile:@"background1_middle.png"];
                bgMiddle2 = [CCSprite spriteWithFile:@"background1_middle.png"];
